...
class _SetPinScreenState extends State<SetPinScreen> {
  ...
  void dispose() {
    ...
    // firstPinCode.dispose();
    // secondPinCode.dispose();
    super.dispose();
  }
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          appBar: commonAppBar("",
              isTrue: true, size: 18, color: Colors.transparent),
          body: SafeArea(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: PinCodeTextField(
                              ...
                              focusNode: _signupController.firstPinCode,
                              validator: (v) {
                                return null;
                              },
                              pinTheme: PinTheme(
                              ...
                              onCompleted: (v) {
                                ...
                                _signupController.firstPinCode.unfocus();
                                _signupController.secondPinCode.requestFocus();
                              },
                              // onTap: () {
                              //   print("Pressed");
                              // },
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                              ...
                              child: PinCodeTextField(
                                ...
                                length: 4,
                                obscureText:
                                    _signupController.isConfirmPin.value,
                                obscuringCharacter: '*',
                                blinkWhenObscuring: true,
                                focusNode: _signupController.secondPinCode,
                                animationType: AnimationType.fade,
                                validator: (v) {
                                  return null;
                                },
                                ...
                                errorAnimationController: errorController,
                                controller:
                                    _signupController.confirmPinController,
                                keyboardType: TextInputType.phone,
                                autoDisposeControllers: false,
                                onCompleted: (v) {
                                  print("Completed");
                    ...
                    CustomButton(
                        ...
                        onPress: () {
                          if (_signupController
                              ...
                              _signupController
                                      .createPinController!.text.length ==
                                  4 &&
                              _signupController
                                  .confirmPinController!.text.isNotEmpty &&
                              _signupController.createPinController!.text
                                      .trim() ==
                            ...
                            print(_signupController.createPinController!.text
                                    .trim() +
                                "==" +
                                _signupController.confirmPinController!.text
                                    .trim());
